...
def run_steepest_ascent(courses: List[Course], rooms: List[Room], time_slots: List[TimeSlot], students: List[Student], lecturers: List[Lecturer],
                        students_in_course: Dict[str, List[Student]], lecturers_in_course: Dict[str, List[Lecturer]]) -> None:
    ...
    final_schedule, obj_history, iters, duration = steepest_ascent_hill_climbing(
        courses, rooms, time_slots, students, lecturers, students_in_course, lecturers_in_course, max_iterations=1000, neighbors_to_check=50
    )
    print(f"\nFinal Result:")
    print(f"  - Final objective: {objective(final_schedule, students, lecturers, students_in_course, lecturers_in_course):.2f}")
...
def run_stochastic(courses: List[Course], rooms: List[Room], time_slots: List[TimeSlot], students: List[Student], lecturers: List[Lecturer],
                   students_in_course: Dict[str, List[Student]], lecturers_in_course: Dict[str, List[Lecturer]]) -> None:
    ...
    final_schedule, obj_history, iters, duration = stochastic_hill_climbing(
        courses, rooms, time_slots, students, lecturers, students_in_course, lecturers_in_course, max_iterations=2000, max_stuck_iterations=100
    )
    print(f"\nFinal Result:")
    print(f"  - Final objective: {objective(final_schedule, students, lecturers, students_in_course, lecturers_in_course):.2f}")
    print(f"  - Iterations until stop: {iters}")
...
def run_sideways_moves(courses: List[Course], rooms: List[Room], time_slots: List[TimeSlot], students: List[Student], lecturers: List[Lecturer],
                       students_in_course: Dict[str, List[Student]], lecturers_in_course: Dict[str, List[Lecturer]]) -> None:
    ...
    final_schedule, obj_history, iters, duration = hill_climbing_with_sideways_moves(
        courses, rooms, time_slots, students, lecturers, students_in_course, lecturers_in_course, max_iterations=1000, max_sideways_moves=100
    )
    print(f"\nFinal Result:")
    print(f"  - Final objective: {objective(final_schedule, students, lecturers, students_in_course, lecturers_in_course):.2f}")
    print(f"  - Iterations until stop: {iters}")
...
def run_random_restart(courses: List[Course], rooms: List[Room], time_slots: List[TimeSlot], students: List[Student], lecturers: List[Lecturer],
                       students_in_course: Dict[str, List[Student]], lecturers_in_course: Dict[str, List[Lecturer]]) -> None:
    ...
    final_schedule, obj_history, total_iters, duration, num_restarts = random_restart_hill_climbing(
        courses, rooms, time_slots, students, lecturers, students_in_course, lecturers_in_course, num_restarts=20, max_iter_per_restart=500
    )
    print(f"\nFinal Result:")
    print(f"  - Global Best objective: {objective(final_schedule, students, lecturers, students_in_course, lecturers_in_course):.2f}")
...
def run_genetic_algorithm(courses: List[Course], rooms: List[Room], time_slots: List[TimeSlot], students: List[Student], lecturers: List[Lecturer],
                          students_in_course: Dict[str, List[Student]], lecturers_in_course: Dict[str, List[Lecturer]]) -> None:
    print("\n5. Genetic Algorithm")
    ...
    final_schedule, statistics = genetic_algorithm(
        courses, rooms, time_slots, students, lecturers, students_in_course, lecturers_in_course, population_size=100, generations=100
    )
...
def run_simulated_annealing(courses: List[Course], rooms: List[Room], time_slots: List[TimeSlot], students: List[Student], lecturers: List[Lecturer],
                            students_in_course: Dict[str, List[Student]], lecturers_in_course: Dict[str, List[Lecturer]]) -> None:
    ...
    final_schedule, final_objective, accept_probs, iterations, stuck_count = simulated_annealing(
        initial_schedule, initial_objective, students, lecturers, students_in_course, lecturers_in_course, time_slots, rooms, 
